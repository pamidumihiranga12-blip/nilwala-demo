...
const TRANSLATIONS = {
  ...
  en: {
    ...
    ticker_countries: "Verified Overseas Destinations",
    ...
    step3_sub: "Upload scanned copies of your documents (PDF, JPG, PNG – Max 5MB each)",
    lbl_cv: "CV / Resume",
    lbl_passport_copy: "Passport Copy",
  ...
  si: {
    ...
    ticker_countries: "විදේශීය රැකියා ගමනාන්ත",
    ...
    step3_sub: "ඔබගේ ලේඛනවල පිටපත් උඩුගත කරන්න (PDF, JPG, PNG – උපරිම 5MB)",
    lbl_cv: "ජීව දත්ත පත්‍රිකාව (CV)",
    lbl_passport_copy: "පාස්පෝට් පිටපත",
  ...
  ta: {
    ...
    ticker_countries: "வெளிநாட்டு வேலைவாய்ப்பு இலக்குகள்",
    ...
    step3_sub: "உங்கள் ஆவணங்களின் நகல்களை பதிவேற்றவும் (PDF, JPG, PNG – அதிகபட்சம் 5MB)",
    lbl_cv: "சுயவிவரக் குறிப்பு (CV)",
...
const DYNAMIC_TRANSLATIONS = {
  ...
  countries: {
    ...
    'United Arab Emirates': { si: 'එක්සත් අරාබි එමීර් රාජ්‍යය', ta: 'ஐக்கிய அரபு அமீரகம்' },
    UAE: { si: 'එක්සත් අරාබි එමීර් (ඩුබායි)', ta: 'ஐக்கிய அரபு அமீரகம் (துபாய்)' },
    ...
    Oman: { si: 'ඕමාන්', ta: 'ஓමාන්' },
    Bahrain: { si: 'බහරේන්', ta: 'பஹ்ரைன்' },
    Japan: { si: 'ජපානය', ta: 'ஜப்பான்' },
    Romania: { si: 'රුමේනියාව', ta: 'ருமேனியா' },
    Cyprus: { si: 'සයිප්‍රසය', ta: 'சைப்ரஸ்' },
    'South Korea': { si: 'දකුණු කොරියාව', ta: 'தென் கொரியா' },
    Singapore: { si: 'සිංගප්පූරුව', ta: 'சிங்கப்பூர்' },
    Malaysia: { si: 'මැලේසියාව', ta: 'மலேசியா' },
    Italy: { si: 'ඉතාලිය', ta: 'இத்தாலி' },
    Poland: { si: 'පෝලන්තය', ta: 'போலந்து' },
    Maldives: { si: 'මාලදිවයින', ta: 'மாலத்தீவு' },
    Seychelles: { si: 'සීෂෙල්ස්', ta: 'சீஷெல்ஸ்' },
    'United Kingdom': { si: 'එක්සත් රාජධානිය', ta: 'ஐக்கிய இராச்சியம்' },
    UK: { si: 'එක්සත් රාජධානිය (UK)', ta: 'ஐக்கிய இராச்சியம் (UK)' },
    Canada: { si: 'කැනඩාව', ta: 'கனடா' },
    Australia: { si: 'ඕස්ට්‍රේලියාව', ta: 'ஆஸ்திரேலியா' },
    'New Zealand': { si: 'නවසීලන්තය', ta: 'நியூசிலாந்து' },
    Germany: { si: 'ජර්මනිය', ta: 'ஜெர்மனி' },
    France: { si: 'ප්‍රංශය', ta: 'பிரான்ஸ்' },
    Malta: { si: 'මෝල්ටාව', ta: 'மால்டா' },
  ...
  faq: {
    en: [
      ...
      { q: 'Which countries are currently available?', a: 'We currently have vacancies in Israel, UAE (Dubai/Abu Dhabi), Qatar, Kuwait, Oman, and Bahrain. Contact us for latest updates.' },
    ...
    si: [
      ...
      { q: 'දැනට රැකියා පවතින රටවල් මොනවාද?', a: 'ඊශ්‍රායලය, එක්සත් අරාබි එමීර් (ඩුබායි/අබුඩාබි), කටාර්, කුවේට්, ඕමාන් සහ බහරේන් යන රටවල් සඳහා කාර්යාංශයේ අනුමත පුරප්පාඩු පවතී.' },
    ...
    ta: [
      ...
      { q: 'தற்போது எந்த நாடுகளில் காலியிடங்கள் உள்ளன?', a: 'இஸ்ரேல், ஐக்கிய அரபு அமீரகம் (துபாய்/அபுதாபி), கத்தார், குவைத், ஓமான் மற்றும் பஹ்ரைன் ஆகிய நாடுகளில் காலியிடங்கள் உள்ளன.' },
  ...
  typewriter: {
    ...
    si: [
      ...
      'ඊශ්‍රායලය, එමීර්, කටාර් සහ කුවේට් සඳහා අනුමත පුරප්පාඩු',
    ...
    ta: [
      ...
      'இஸ்ரேல், அரபு அமீரகம், கத்தார் நாடுகளுக்கான சிறந்த வேலைகள்',
...
if (typeof window !== "undefined") {
  ...
  window.DYNAMIC_TRANSLATIONS = DYNAMIC_TRANSLATIONS;
}
